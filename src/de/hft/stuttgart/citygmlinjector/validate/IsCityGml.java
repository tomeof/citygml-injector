...
package de.hft.stuttgart.citygmlinjector.validate;

import de.hft.stuttgart.citygmlinjector.contract.IValidationRule;
import de.hft.stuttgart.citygmlinjector.state.Context;

public class IsCityGml extends BaseValidationRule implements IValidationRule{

	public IsCityGml(Context context) {
		super(context);
	}

	@Override
	public boolean check() {
		if (context.rootNodeName.equals("CityModel")) {
			return true;
		}else if (context.rootNodeName.equals("core:CityModel")) {
			return true;
		}else {
			return false;
		}
