...
package de.hft.stuttgart.citygmlinjector.exception;

public class FileNotCityGmlException extends Exception {

	private static final long serialVersionUID = -4797430537622212964L;
	
	public FileNotCityGmlException() {
	}

	public FileNotCityGmlException(String message) {
		super(message);
	}
